...
if __name__ == '__main__':
    ...
    parser.add_argument('--manager', default='127.0.0.1:5000', help='Hostname to listen on (default: 127.0.0.1)')
    args = parser.parse_args()
    manager_endpoint=args.manager
    time.sleep(5)
    print("Notifying manager after server starts")
    # Notifying manager after server starts
    notify_manager()
