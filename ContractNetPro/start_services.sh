...
nohup python $CONTRACTOR_SCRIPT --port $CONTRACTOR1_PORT --manager $MANAGER_ENDPOINT > logs/contractor1.log 2>&1 &
nohup python $CONTRACTOR_SCRIPT --port $CONTRACTOR2_PORT --manager $MANAGER_ENDPOINT > logs/contractor2.log 2>&1 &
nohup python $CONTRACTOR_SCRIPT --port $CONTRACTOR3_PORT --manager $MANAGER_ENDPOINT > logs/contractor3.log 2>&1 &
...
nohup locust -f $LOCUST_SCRIPT --host http://127.0.0.1:$MANAGER_PORT > logs/locust.log 2>&1 &
